                        ...
                        <div class="match-modal-scoreboard"
                            x-data="{
                                ...
                                tick() {
                                    ...
                                    if (this.phase === 'full_time') { this.period = 'Full Time'; this.display = 'FT'; return; }
                                    this.period = '—'; this.display = '—';
                                },
                                destroy() { if (this._id) clearInterval(this._id); }
                            }"
                                                ...
                                                @foreach($selectedMatch->events as $event)
                                                    @php
                                                        ...
                                                        $eventColors = [
                                                            ...
                                                            'yellow_card' => ['icon' => 'bi-square-fill', 'color' => '#f5a622', 'bg' => 'rgba(245,166,34,.08)'],
                                                            'second_yellow' => ['icon' => 'bi-square-fill', 'color' => '#f5a622', 'bg' => 'rgba(245,166,34,.08)'],
