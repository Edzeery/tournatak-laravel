<div>
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb" style="font-size:0.85rem;">
            ...
            <li class="breadcrumb-item active">تعديل اللاعب</li>
        </ol>
    </nav>

    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold mb-1" style="color:var(--dark);"><i class="bi bi-pencil text-gold"></i> تعديل اللاعب</h4>
            <p class="text-muted mb-0" style="font-size:0.9rem;">{{ $player->user->name ?? '' }}</p>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3 d-flex align-items-end">
                        <div class="form-check">
                            ...
                            <label class="form-check-label fw-bold" for="is_captain_edit">قائد الفريق</label>
                        </div>
                    </div>
                </div>
