...
return [
    ...
    '_shared' => [
        ...
        'postponed' => ['variant' => 'warning', 'light' => 'text-yellow-700 bg-yellow-100',  'dark' => 'dark:text-yellow-300 dark:bg-yellow-900/40', 'hex' => '#facc15', 'icon' => 'delayed'],
        'abandoned' => ['variant' => 'danger',  'light' => 'text-red-700 bg-red-100',        'dark' => 'dark:text-red-300 dark:bg-red-900/40',       'hex' => '#dc2626', 'icon' => 'canceled'],
    ...
    'match' => [
        'scheduled' => ['icon' => 'calendar'],
        'in_progress' => ['variant' => 'danger', 'light' => 'text-red-700 bg-red-100', 'dark' => 'dark:text-red-300 dark:bg-red-900/40', 'hex' => '#dc2626', 'icon' => 'play-circle'],
        'completed' => 'completed',
        'postponed' => 'postponed',
        'cancelled' => 'cancelled',
        'pending' => 'pending',
