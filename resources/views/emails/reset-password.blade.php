...
<head>
    ...
    <style>
        ...
        .container { max-width:560px; margin:40px auto; background:#111827; border-radius:16px; padding:48px 40px; border:1px solid rgba(245,166,34,0.15); }
        .logo { text-align:center; margin-bottom:32px; }
        .logo span { font-size:1.6rem; font-weight:bold; color:#f5a622; }
        ...
        .btn { display:block; width:100%; padding:16px; background:#f5a622; color:#0a0e1a; text-decoration:none; text-align:center; border-radius:12px; font-weight:bold; font-size:1.05rem; margin:28px 0; }
