...
<li class="nav-item">
    <div class="dropdown">
        <button class="nav-link dropdown-toggle d-flex align-items-center gap-1 text-primary" data-bs-toggle="dropdown" >
            ...
            <span class="d-none d-lg-inline fs-base">{{ match($currentLocale) { 'ar' => 'عربي', 'en' => 'EN', 'fr' => 'FR', 'es' => 'ES', default => 'EN' } }}</span>
        </button>
        <ul class="dropdown-menu dropdown-menu-end border-0 shadow-lg rounded-lg-custom bg-chrome-3 dropdown-w-160">
            <li>
            ...
            <li><hr class="dropdown-divider my-1 border-chrome-bottom"></li>
            <li>
