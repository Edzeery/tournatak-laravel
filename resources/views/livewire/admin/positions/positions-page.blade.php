<div>
    <x-section-header
        ...
        :title="__('app.position_management')"
        :subtitle="__('app.positions_desc')"
        :breadcrumbs="[
            ['route' => route('admin.dashboard'), 'label' => __('app.dashboard')],
            ['label' => __('app.positions')],
        ]"
    >
        <x-slot:action>
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            ...
                                            <button class="btn btn-sm btn-outline-danger rounded-md"
                                                    x-on:click.prevent="confirmAction({ title: @js(__('app.confirm_delete_title')), text: @js(__('app.confirm_delete_position')), icon: 'warning', confirmButtonText: @js(__('app.confirm_delete_yes')), cancelButtonText: @js(__('app.confirm_delete_cancel')) }).then(ok => ok && $wire.deletePosition({{ $pos->id }}))"
