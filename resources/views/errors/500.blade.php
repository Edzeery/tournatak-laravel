...
<head>
    ...
    <style>
        ...
        .error-code { font-size:8rem; font-weight:900; background:linear-gradient(135deg,#f5a622,#d98f1d); -webkit-background-clip:text; -webkit-text-fill-color:transparent; line-height:1; margin-bottom:0.5rem; }
        .error-icon { font-size:4rem; color:rgba(245,166,34,0.3); margin-bottom:1rem; animation:pulse 2s ease-in-out infinite; }
        ...
        .error-btn { display:inline-flex; align-items:center; gap:8px; padding:12px 32px; background:linear-gradient(135deg,#f5a622,#d98f1d); color:#0a0e1a; font-weight:700; border:none; border-radius:12px; text-decoration:none; font-size:1rem; transition:transform 0.2s,box-shadow 0.2s; }
        .error-btn:hover { transform:translateY(-2px); box-shadow:0 8px 25px rgba(245,166,34,0.3); color:#0a0e1a; }
