        ...
        <div class="card-body p-4">
            <form wire:submit="store">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <label class="form-label fw-bold">{{ __('app.user') }} <span class="text-danger">*</span></label>
                        <input type="text" class="form-control mb-2"
                            placeholder="{{ __('app.search_user_placeholder') }}"
                            wire:model.live.debounce.300ms="searchUser">
                        <select class="form-select" wire:model="user_id" required size="5">
